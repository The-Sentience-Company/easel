...
const TEMPLATES = { review: 'review.js', eval: 'eval.js', 'answer-key': 'answer-key.js', page: 'page.js', queue: 'queue.js', rulings: 'rulings.js', compare: 'compare.js', gallery: 'gallery.js' }
